...
# create a BLAST nucleotide database from haplotype 1 assembly
# -dbtype: specify nucleotide database
# -in: input FASTA file
# -out: output database name/path
makeblastdb -dbtype nucl -in /share/BioinfMSc/rot3_group2/C087_203_mapq_hap1_8.fa -out /share/BioinfMSc/rot3_group2/BLAST/hap1_database
