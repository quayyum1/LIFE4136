...
# activate connda env with augustus installed
conda activate Augustus

# run Augustus gene prediction:
# --gff3=on: Output in GFF3 format
# --species=arabidopsis: Use Arabidopsis thaliana model
augustus --gff3=on --species=arabidopsis /share/BioinfMSc/rot3_group2/C087_203_mapq_hap1_8.fa > /share/BioinfMSc/rot3_group2/Augustus/hap1.gff
