...
# change to installatino directory
cd /share/BioinfMSc/rot3_group2/quarTet/quarTeT

# run quartet to identify telomeric repeats in haplotype 1 assembly
# -i: input FASTA file
# -c: specify organism type (plant)
# -m: minimum repeat length
# -p: output prefix
python3 quartet.py TeloExplorer -i /share/BioinfMSc/rot3_group2/C087_203_mapq_hap1_8.fa -c plant -m 100 -p hap1.telo

# deactivate conda end
conda deactivate
